  ...
  return (
    <div className="lg:flex lg:items-center lg:gap-10">
      <motion.div
        ...
        className="relative hidden lg:flex lg:flex-shrink-0 lg:justify-center"
      >
        <Image
          ...
          height={240}
          priority
          className="rounded-full border border-slate-200 object-cover shadow-xl shadow-brand-500/20 dark:border-slate-700"
        />
      </motion.div>
